        ...
        if people[person]["mother"] is None:
            ...
            for parent in mother, father:
                prob = (
                    ...
                    else 0.5 if parent in two_genes else (1 - PROBS["mutation"])
                )
                parent_prob[parent] = prob

            if gene_copies == 0:
                joint_probability *= (1 - parent_prob[mother]) * (
                    1 - parent_prob[father]
                )
            elif gene_copies == 1:
                joint_probability *= (1 - parent_prob[mother]) * parent_prob[
                    father
                ] + parent_prob[mother] * (1 - parent_prob[father])
            else:
                joint_probability *= parent_prob[mother] * parent_prob[father]

            joint_probability *= trait_prob
